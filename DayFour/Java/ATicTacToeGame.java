			...
			for (int index2 = 0; index2 < ticTacToe[0].length; index2++)
			{
				...
				switch(userPosition) {
					case "top left":
						...
						System.out.println("\n" + ticTacToe[0][0] + "\n");
						if (ticTacToe[0][0] != null) indexPositionTaken++;
						
						switch(isIndexPositionTaken) {
							case 1:
								System.out.println("Sorry this slot is taken, you're gonna have to play in a different position.");
							break;
						}
					break;
					case "top center":
